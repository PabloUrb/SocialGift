...
public class ShowUserProfile extends AppCompatActivity {
    ...
    public void showUserData(User user) {
        ...
        userController.getWishlistsCountOther(user.getId(), new UsersController.DataManagerCallback<Integer>() {
            @Override
        ...
        userController.getReservedGiftsCountOther(user.getId(), new UsersController.DataManagerCallback<Integer>() {
            @Override
            public void onSuccess(Integer count) {
        ...
        userController.getFriendsCountOther(user.getId(),new UsersController.DataManagerCallback<Integer>() {
            @Override
            public void onSuccess(Integer count) {
